...
dragon = Movie("Crunching Tiger Hidden Dragon",
               "The film is set in the Qing Dynasty during the 43rd year of"
...
revolver = Movie("Revolver",
                 "Dorothy Macha is a gang boss involved in illegal gambling "
                 "all over the city.",
                 "http://ecx.images-amazon.com/images/I/51FHH9YR1DL.jpg",
                 "https://www.youtube.com/watch?v=M9JAYfZOHms")

insidious = Movie("Insidious",
                  "A married couple, their sons Dalton and Foster, and infant "
                  "daughter Cali have recently moved into a new home.",
...
imcyborg = Movie("Im a cyborg, but that is ok",
                 "The film takes place mostly in a mental institution filled "
                 "with an eclectic menagerie of patients",
                 "http://www.marthagarzon.com/contemporary_art/wp-content/"
                 "gallery/cyborg/im_a_cyborg_but_thats_ok.jpg",
                 "https://www.youtube.com/watch?v=-QrmBQ8QoVw")

movies = [number23, revolver, avatar,
